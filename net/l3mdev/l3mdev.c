				 ...
				 int (*fn)(struct net *net, u32 table_id))
{
	...
	if (hdlr->l3type != L3MDEV_TYPE_UNSPEC || hdlr->dev_lookup) {
		res = -EBUSY;
		goto unlock;
	}
				    ...
				    int (*fn)(struct net *net, u32 table_id))
{
	...
	if (hdlr->l3type != l3type || hdlr->dev_lookup != fn)
		goto unlock;
...
int l3mdev_ifindex_lookup_by_table_id(struct net *net, u32 table_id,
				      enum l3mdev_type l3type)
{
